<link href="https://fonts.googleapis.com/css2?family=Soin+Sans+Pro:wght@400;700&display=swap" rel="stylesheet">
...
<style>
    ...
    /* Font for paragraph text */
    p {
        font-family: 'Open Sans', sans-serif; /* Use Open Sans font for paragraph text */
    ...
    /* Font for buttons */
    .btn {
        font-family: 'Montserrat', sans-serif; /* Use Montserrat font for buttons */
    ...
    <section class="py-5 text-center">
        <div class="row py-lg-5" data-aos="fade-up"     data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out">
            ...
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p>
                    <a href="#our_goals" class="btn btn-primary my-2">Our Goals</a>
                </p>
            </div>
        </div>
    </section>
